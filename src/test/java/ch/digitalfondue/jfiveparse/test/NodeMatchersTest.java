...
class NodeMatchersTest {
    ...
    void firstChildTest() {
        ...
        var w3cMatcher = W3CDom.select().isFirstChild().toMatcher();
        ...
        var w3cDiv = W3CDom.getAllNodesMatching(w3cDoc.getElementsByTagName("body").item(0), w3cMatcher).toList();
    ...
    void universalTest() {
        ...
        var w3cMatcher = W3CDom.select().element("div").withDescendant().universal().toMatcher();
        var w3cDoc = W3CDom.toW3CDocument(doc);

        // div *
        List<Node> universal = doc.getElementsByTagName("body").get(0).getAllNodesMatching(matcher);
        var w3cUniversal = W3CDom.getAllNodesMatching(w3cDoc.getElementsByTagName("body").item(0), w3cMatcher).toList();
    ...
    void firstElementTest() {
        ...
        var w3cMatcher = W3CDom.select().isFirstElementChild().toMatcher();
        List<Node> div = doc.getElementsByTagName("body").get(0).getAllNodesMatching(matcher);
        assertEquals(1, div.size());
    ...
    void lastElementTest() {
        ...
        var w3cMatcher = W3CDom.select().isLastElementChild().toMatcher();
        List<Node> div = doc.getElementsByTagName("body").get(0).getAllNodesMatching(matcher);
        assertEquals(1, div.size());
    ...
    void lastChildTest() {
        ...
        var w3cmatcher = W3CDom.select().isLastChild().toMatcher();
    ...
    void hasAttributeValueEqTest() {
        ...
        var w3cmatcher = W3CDom.select().attrValEq("id", "myid").toMatcher();
        List<Node> divIdMyId = doc.getAllNodesMatching(matcher);
        assertEquals(1, divIdMyId.size());

        var w3cDivIdMyId = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
        assertEquals(1, w3cDivIdMyId.size());


        matcher = Selector.select().attr("id").toMatcher();
        w3cmatcher = W3CDom.select().attr("id").toMatcher();
        ...
        var w3cDivId = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
    ...
    void hasAttributeValueInListTest() {
        ...
        var w3cmatcher = W3CDom.select().attrValInList("class", "class1").toMatcher();
        ...
        var w3cDivClass = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
        ...
        w3cmatcher = W3CDom.select().attrValInList("class", "class2").toMatcher();
        List<Node> divClasses = doc.getAllNodesMatching(matcher);
        assertEquals(2, divClasses.size());

        var w3cDivClasses = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
    ...
    void hasAttributeValueStartWithTest() {
        ...
        var w3cmatcher = W3CDom.select().attrValStartWith("class", "class2 class1").toMatcher();
        ...
        w3cmatcher = W3CDom.select().attrValStartWith("class", "class2").toMatcher();
        List<Node> divClasses = doc.getAllNodesMatching(matcher);
        assertEquals(2, divClasses.size());
    ...
    void hasAttributeValueEndWithTest() {
        ...
        var w3cmatcher = W3CDom.select().attrValEndWith("class", "class1 class3").toMatcher();
        List<Node> divClass = doc.getAllNodesMatching(matcher);
        assertEquals(1, divClass.size());
        assertEquals("class2 class1 class3", ((Element) divClass.get(0)).getAttribute("class"));
        ...
        w3cmatcher = W3CDom.select().attrValEndWith("class", "class3").toMatcher();
        List<Node> divClasses = doc.getAllNodesMatching(matcher);
        assertEquals(2, divClasses.size());
    ...
    void hasAttributeValueContainTest() {
        ...
        var w3cmatcher = W3CDom.select().attrValContains("class", "class2 class1").toMatcher();
        ...
        w3cmatcher = W3CDom.select().attrValContains("class", "cl").toMatcher();
        List<Node> divClasses = doc.getAllNodesMatching(matcher);
        assertEquals(2, divClasses.size());
    ...
    void hasParentMatch() {
        ...
        var w3cmatcher = W3CDom.select().attrValEq("id", "depth1").withChild().toMatcher();
        List<Node> e = doc.getAllNodesMatching(matcher);
        assertEquals(1, e.size());
        assertEquals("depth2", ((Element) e.get(0)).getAttribute("id"));

        var w3ce = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
        ...
        w3cmatcher = W3CDom.select().attrValEq("id", "depth0").withChild().toMatcher();
        List<Node> empty = doc.getAllNodesMatching(matcher);
        assertEquals(0, empty.size());

        assertEquals(0, W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList().size());
    }
    ...
    void hasAncestorMatch() {
        ...
        w3cmatcher = W3CDom.select().attrValEq("id", "depth1").withDescendant().toMatcher();
        ...
        var w3ce2 = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
        ...
        w3cmatcher = W3CDom.select().attrValEq("id", "depth0").withDescendant().toMatcher();
        List<Node> empty = doc.getAllNodesMatching(matcher);
        assertEquals(0, empty.size());

        var w3cEmpty = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
    ...
    void hasSelectorMatch() {
        ...
        var w3cmatcher = W3CDom.select().id("depth1").withChild().id("depth2").withChild().id("depth3").toMatcher();
        List<Node> e1 = doc.getAllNodesMatching(matcher);
        assertEquals(1, e1.size());
        assertEquals("depth3", ((Element) e1.get(0)).getAttribute("id"));
        ...
        w3cmatcher = W3CDom.select().element("div").withDescendant().attr("id").toMatcher();
        List<Node> e2 = doc.getAllNodesMatching(matcher);
        assertEquals(2, e2.size());
        assertEquals("depth2", ((Element) e2.get(0)).getAttribute("id"));
        assertEquals("depth3", ((Element) e2.get(1)).getAttribute("id"));
        ...
        w3cmatcher = W3CDom.select().element("div").hasClass("a", "b").toMatcher();
        List<Node> e3 = doc.getAllNodesMatching(matcher);
        assertEquals(1, e3.size());
        assertEquals("depth1", ((Element) e3.get(0)).getAttribute("id"));

        var w3ce3 = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
        ...
        w3cmatcher = W3CDom.select().hasClass("c").toMatcher();
        List<Node> e4 = doc.getAllNodesMatching(matcher);
        assertEquals(3, e4.size());

        var w3ce4 = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
        assertEquals(3, w3ce4.size());

        // .b
        matcher = Selector.select().hasClass("b").toMatcher();
        w3cmatcher = W3CDom.select().hasClass("b").toMatcher();
        ...
        var w3ce5 = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
        ...
        w3cmatcher = W3CDom.select().hasClass("a").withDescendant().hasClass("c").toMatcher();
        ...
        var w3ce6 = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
        ...
        w3cmatcher = W3CDom.select().hasClass("a").withDescendant().hasClass("a").toMatcher();
        List<Node> e7 = doc.getAllNodesMatching(matcher);
        assertEquals(1, e7.size());
        assertEquals("depth2", ((Element) e7.get(0)).getAttribute("id"));

        var w3ce7 = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
    ...
    void selectorFirstLast() {
        ...
        var w3cmatcher = W3CDom.select().element("div").isFirstChild().toMatcher();
        assertTrue(doc.getAllNodesMatching(matcher).isEmpty());
        assertTrue(W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList().isEmpty());

        // :first-child
        matcher = Selector.select().isFirstChild().toMatcher();
        w3cmatcher = W3CDom.select().isFirstChild().toMatcher();
        ...
        var w3cNodes = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
        ...
        w3cmatcher = W3CDom.select().element("body").withDescendant().isFirstChild().toMatcher();
        List<Node> txtNode = doc.getAllNodesMatching(matcher);
        var w3cTxtNode = W3CDom.getAllNodesMatching(w3cDoc, w3cmatcher).toList();
